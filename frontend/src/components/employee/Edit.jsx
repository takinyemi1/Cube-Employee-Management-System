...
const Edit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put( // since data is being updated
    ...
    return (
        <>{departments && employee ? ( 
            <div className="p-6" style={{ fontFamily: "Dosis", backgroundColor: "#f0f2cc" }}>
                <div className="max-w-4xl mx-auto mt-10 p-8 rounded-md shadow-md" style={{ color: "white", backgroundColor: "#93db97ff" }}>
